...
namespace ProjectMonitor.utils
{
    public class EmailUtils
    {
        ...
        public EmailUtils(string server, string toMail, string fromMail, string subject, string emailBody, string username, string password, string port, bool sslEnable, bool pwdCheckEnable)
        {
            try
            {
